...
int main()
{
	...
	cv::Point3f point2find1_CF = p4psolver1.ImageFrame2CameraFrame(point2find1_IF, 350);//待求点P在图一状态下的相机坐标系坐标
	...
	cv::Point2f point2find2_IF = cv::Point2f(3439, 2691);//待求点P在图2中的坐标
	...
	cv::Point3f point2find2_CF = p4psolver2.ImageFrame2CameraFrame(point2find2_IF, 350);//待求点P在图二状态下的相机坐标系坐标
